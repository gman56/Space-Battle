...
public class Missile extends Ship implements Runnable
{
	...
	public Missile(String id, String colorName, Point3D location, Point3D destination, 
	...
	public void run()
	{
		...
		{
			String newTarget = SpaceController.reacquireRadarLock(id, location, target, cName, radarRange);
